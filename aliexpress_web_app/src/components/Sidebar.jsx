...
const Sidebar = () => {
    return (
        <div className=''>
            <aside id="logo-sidebar" class="absolute top-16 left-0 z-40 w-52 h-screen transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 py-12 overflow-y-auto bg-purple-100">
                    <ul class="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to={'/cart'} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span class="flex-1 ms-3 whitespace-nowrap">Cart Items</span>
                            </Link>
                        </li>
                        <li>
